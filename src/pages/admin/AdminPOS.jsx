...
export default function AdminPOS() {
  ...
  const fetchData = async () => {
    const [resTables, resIngredients] = await Promise.all([
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
            ...
            <div className="flex gap-2 mb-4">
                <input placeholder="Nom" className="border p-2 rounded" value={newTable.nom} onChange={e => setNewTable({...newTable, nom: e.target.value})} />
                <input placeholder="Capacité" className="border p-2 rounded" value={newTable.capacite} onChange={e => setNewTable({...newTable, capacite: e.target.value})} />
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
            ...
            <div className="flex gap-2 mb-4">
                <input placeholder="Nom" className="border p-2 rounded" value={newIngredient.nom} onChange={e => setNewIngredient({...newIngredient, nom: e.target.value})} />
                <input placeholder="Stock" className="border p-2 rounded" value={newIngredient.stock_qty} onChange={e => setNewIngredient({...newIngredient, stock_qty: e.target.value})} />
